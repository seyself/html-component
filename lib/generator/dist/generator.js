...
init = function() {
  ...
  return jsx.LayoutPreviewGenerator = (function() {
    ...
    _getAssetFilePathList = function(dest, filePathList) {
      return filePathList.forEach(function(code) {
        var src;
        code = code.replace(/"/g, '');
