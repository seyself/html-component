...
init = function() {
  ...
  return jsx.LayoutPreviewGenerator = (function() {
    var $, _assets, _compareNodeHeight, _componentExportable, _components, _copyComponentAssets, _copyHTMLAssets, _createComponentCSS, _createComponentFiles, _createComponents, _createDestDir, _createElementCSS, _createElementTag, _createFilePath, _createHTML, _createHTMLCode, _createPackageJson, _createStyleSheet, _createTextElementCSS, _data, _deleteQuartFromURLText, _exportCssFile, _exportHTML, _exportJadeFile, _generateCSS, _generateInit, _generateNode, _generateNodeList, _generateRelativeLayout, _getAssetFilePathList, _getBasicStyle, _getIndent, _getMetaData, _getStylePSE, _getText, _isComponent, _isComponentDebugJS, _isFullURL, _isIgnoreAssetFilePath, _isPositionRelative, _makeAssetPathList, _makeComponent, _packageJsonTemplate, _params, _ref_elements, _replaceAssetPath, _replaceJadeFormat, _setAssetPathList, _setClassPath, _setComponentFiles, _setEmbed, _writePackageJsonTemplate;
