...
var RESTClient, _cheerio, beautify, exec, fs, jsx, path;
...
jsx.LayoutPreviewGenerator = (function() {
  var $, _assets, _componentExportable, _components, _copyComponentAssets, _createComponentFiles, _createComponents, _createElementCSS, _createElementTag, _createHTML, _createTextElementCSS, _data, _generateNode, _generateNodeList, _generateRelativeLayout, _getBasicStyle, _getMetaData, _getStylePSE, _getText, _isPositionRelative, _ref_elements, _replaceAssetPath;
  ...
  LayoutPreviewGenerator.prototype.generate = function() {
    var $body, $main, body, doc, html, params, style;
  ...
  _replaceAssetPath = function(data, html) {
    var asset, assetDir, dst, dstBase, dstDir, j, len1, matches, pathes, result, src;
    pathes = [];
    result = {
      html: html,
