...
init = function() {
  ...
  return jsx.LayoutPreviewGenerator = (function() {
    var $, _assets, _compareNodeHeight, _componentExportable, _components, _copyComponentAssets, _copyHTMLAssets, _createComponentCSS, _createComponentFiles, _createComponents, _createDestDir, _createElementCSS, _createElementTag, _createHTML, _createPackageJson, _createTextElementCSS, _data, _deleteQuartFromURLText, _exportCssFile, _exportJadeFile, _generateCSS, _generateNode, _generateNodeList, _generateRelativeLayout, _getAssetFilePathList, _getBasicStyle, _getIndent, _getMetaData, _getStylePSE, _getText, _isComponent, _isComponentDebugJS, _isFullURL, _isIgnoreAssetFilePath, _isPositionRelative, _makeAssetPathList, _makeComponent, _packageJsonTemplate, _params, _ref_elements, _replaceAssetPath, _replaceJadeFormat, _setAssetPathList, _setClassPath, _setComponentFiles, _setEmbed, _writePackageJsonTemplate;
    ...
    LayoutPreviewGenerator.prototype.generate = function(params) {
      ...
      return _createDestDir(dest, function() {
        ...
        return _copyHTMLAssets(html, function() {
          return _exportJadeFile(_params, html, jadeFile, stylusFile, style, cssFile);
        });
      });
    };
