...
init = function() {
  ...
  return jsx.LayoutPreviewGenerator = (function() {
    var $, _assets, _compareNodeHeight, _componentExportable, _components, _copyComponentAssets, _copyHTMLAssets, _createComponentCSS, _createComponentFilePath, _createComponentFiles, _createComponents, _createCopyList, _createDestDir, _createElementCSS, _createElementTag, _createFilePath, _createHTML, _createHTMLCode, _createPackageJson, _createStyleSheet, _createTextElementCSS, _data, _deleteQuartFromURLText, _exportCssFile, _exportHTML, _exportJadeFile, _generateCSS, _generateInit, _generateNode, _generateNodeList, _generateRelativeLayout, _getAssetFilePathList, _getBasicStyle, _getIndent, _getMetaData, _getStylePSE, _getText, _isComponent, _isComponentDebugJS, _isFullURL, _isIgnoreAssetFilePath, _isPositionRelative, _makeAssetPathList, _packageJsonTemplate, _params, _ref_elements, _replaceAssetPath, _replaceJadeFormat, _setAssetPathList, _setClassPath, _setComponentFiles, _setConfig, _writePackageJsonTemplate;
    ...
    _generateNode = function(node, parentName, indentLevel, doc, layers, $root, $element, result, offsetX, offsetY, component, isRoot) {
      var $$, $copm, $div, childContainer, cname, config, css, isComponentRoot, ref, ref_id, ref_node, tag;
