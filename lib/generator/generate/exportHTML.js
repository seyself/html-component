...
function _copyComponentsCheckFiles() {
  var componentsPath = _path2.default.join(_moduleDir, '../../../../../components');
  var componentsSrcPath = _path2.default.join(_moduleDir, '../../../components');
  if (!isComponentCheckFiles(_path2.default.join(componentsPath, '/libs'))) {
    (0, _exec2.default)('cp -r ' + componentsSrcPath + '/libs ' + componentsPath, function () {});
  }
  if (!isComponentCheckFiles(_path2.default.join(componentsPath, '/html-component'))) {
    (0, _exec2.default)('cp -r ' + componentsSrcPath + '/html-component ' + componentsPath, function () {});
  }
}
