...
export function createStyleSheet(jsonData, params, components){
  _components = components;
  _params = params;
  $ = _cheerio.load('<div><div id="main" class="_' + jsonData.document.filename + '"></div></div>', {decodeEntities: false});
  var $main = $('div#main');
  var params = {};
