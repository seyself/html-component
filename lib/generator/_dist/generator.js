...
init = function() {
  ...
  return jsx.LayoutPreviewGenerator = (function() {
    var $, _appendCSSElementIndent, _appendComponent, _appendComponentElement, _appendNodeOption, _appendReferenceNode, _assets, _compareNodeHeight, _componentExportable, _components, _copyComponentAssets, _copyHTMLAssets, _createComponentCSS, _createComponentFilePath, _createComponentFiles, _createComponents, _createCopyList, _createDestDir, _createElementCSS, _createElementTag, _createFilePath, _createGulpFile, _createHTML, _createHTMLCode, _createPackageJson, _createResultCSS, _createSrcFiles, _createStyleSheet, _createTextElementCSS, _data, _deleteQuartFromURLText, _exportCssFile, _exportHTML, _exportJadeFile, _generateCSS, _generateInit, _generateNode, _generateNodeList, _generateRelativeLayout, _getAssetFilePathList, _getBasicStyle, _getIndent, _getMetaData, _getStylePSE, _getText, _isComponent, _isComponentDebugJS, _isFullURL, _isIgnoreAssetFilePath, _isPositionRelative, _layerNameIsLink, _makeArgumentList, _packageJsonTemplate, _params, _ref_elements, _replaceAssetPath, _replaceJadeFormat, _setAssetPathList, _setClassPath, _setComponentFiles, _setConfig, _setDataBackground, _setDataPosition, _writePackageJsonTemplate;
    ...
    _exportHTML = function(params, filePath, data) {
      return _createDestDir(params.dest, function() {
        ...
        return _copyHTMLAssets(data.html, function() {
      ...
      if (params.export_jade) {
        return exec('mkdir -p ' + './src/pages', function() {
          return html2jade.convertHtml(html, {
            ...
            return _exportCssFile(stylusFile, style, cssFile);
          });
        });
      } else {
        if (_componentExportable) {
    ...
    _exportCssFile = function(stylusFile, style, cssFile) {
    ...
    _createCopyList = function(pathes) {
    ...
    _writePackageJsonTemplate = function() {
      var tmplPath;
    ...
    _createGulpFile = function(data) {
      var gulpFilePath, tmplGulpPath;
      ...
      return exec('cp ' + tmplGulpPath + ' ' + gulpFilePath, function() {
        return console.log('-------- create gulp');
      });
    };
    ...
    _setAssetPathList = function(dstBase, src, result) {
    ...
    if (_options.root.docs_url) {
      try {
        ...
        client.get(_options.root.docs_url, function(data, response) {
          var cols, e, error, i, j, key, len, ref, tsv, value;
          try {
            if (data) {
              _meta = {};
